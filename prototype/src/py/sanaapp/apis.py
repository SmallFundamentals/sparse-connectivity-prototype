...
def return_checksums():
    ...
    response_payload = _get_checksums_as_payload(file_name, file_size)
...
def receive_instruction():
    ...
    response_payload = _get_checksums_as_payload(file_name)
    return jsonify(**response_payload), 200


def _get_checksums_as_payload(file_name, file_size=None):
    response_payload = {}
